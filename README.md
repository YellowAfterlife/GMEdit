...
* Build the project via `haxe -cp src -js ./bin/resources/app/app.js -main Main -dce full` or `npm run compile` (or open and run the included FlashDevelop project)
  ...
  You'll need at least a [Release Candidate version of Haxe 4](https://haxe.org/download/version/4.0.0-rc.1/) - Haxe 3 will not work out of box due to API changes between the two.
